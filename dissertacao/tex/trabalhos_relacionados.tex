...
primeiros são similares às categorias \cat{cultura de colaboração}, \cat{agilidade}
e \cat{automação} aqui apresentadas. A partir desses {\it DevOps drivers}, e
...
\emph{monitoramento} aqui faz parte da categoria \cat{mediçãoc ontínua}. Já
