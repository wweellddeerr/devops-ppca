...
Estes pipelilnes ocasionam dois outros conceitos da categoria \cat{agilidade}:
...
categoria \cat{resiliência} nesse contexo à capacidade que as aplicações
...
zero \emph{down-time}}, que é o último da categoria de \cat{resilience} e indica
