...
\begin{document}%
    ...
    \capitulo{3_GT_Adocao_DevOps}{Uma \textit{Grounded Theory} Sobre a Adoção de DevOps na Indústria}%
    \capitulo{4_Modelo_Adocao_DevOps}{Um Modelo para Adoção de DevOps e sua Aplicação no \acrshort{TCU}}%
